...
import uz.pdp.hr_management.repository.RoleRepository;
import uz.pdp.hr_management.security.JwtProvider;
...
public class AuthService implements UserDetailsService {
    ...
    public void sendEmail(String email, Date deadline) {
        ...
        simpleMailMessage.setText("You have been assigned a task. Task deadline by "+simpleDateFormat.format(deadline).toString());
        javaMailSender.send(simpleMailMessage);
    }
